...
# Does NOT: commit, push, open PRs, or write to per-company feeds — those
# need agent reasoning ("is this signal or noise?") and belong in the
# heartbeat/manual review, not a cron script.
